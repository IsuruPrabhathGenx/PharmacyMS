        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="space-y-4">
            ...
            {filteredCustomers.length === 0 ? (
              <p key="no-customers" className="text-sm text-muted-foreground text-center py-4">
                No customers found
              </p>
            ) : (
              filteredCustomers.map((customer) => (
                <button
                  ...
                  className="w-full px-4 py-3 text-left rounded-lg hover:bg-accent transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 mb-1"
                  onClick={() => {
